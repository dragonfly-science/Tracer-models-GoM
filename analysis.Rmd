...
opts_chunk$set(warning=FALSE,message=FALSE,tidy=FALSE,fig.width = 12,fig.height=8,dpi = 300)
...
FAS <- which(colnames(BCvsBC.data.PS$datas.FA$preds.FA) %in% c('18_1n9c',
                                                        ...
                                                        '18_0',
                                                        '18_3n6'))
BC.data.PS.sub <- fastinR::select_vars(BC.data.PS, FAS[1:7])
par(mfrow=c(2,1))
dataplot(BC.data.PS)
...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP, FAS[1:6])
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS, FAS[1:6])
par(mfrow=c(2,1))
...
BCvsBC.data.WP.sub <- fastinR::select_vars(BCvsBC.data.WP, FAS[1:6])
par(mfrow=c(2,1))
...
KF.data.PS.sub <- fastinR::select_vars(KF.data.PS, FAS[1:6])
par(mfrow=c(2,1))
dataplot(KF.data.PS)
...
KF.data.WP.sub <- fastinR::select_vars(KF.data.WP, FAS[1:6])
par(mfrow=c(2,1))
...
AC.data.PS.sub <- fastinR::select_vars(AC.data.PS, FAS[1:6])
par(mfrow=c(2,1))
dataplot(AC.data.PS)
...
AC.data.WP.sub <- fastinR::select_vars(AC.data.WP, FAS[1:6])
par(mfrow=c(2,1))
