...
SI_cols <- which(colnames(prey) %in% c('d13C', 'd1N'))
...
FAS <- which(colnames(BCvsBC.data.PS$datas.FA$preds.FA) %in% c('18_1n9c',
                                                        '18_3n3',
                                                        '22_6n3',
                                                        '16_1n7',
                                                        '16_0',
                                                        ...
                                                        '18_0',
                                                        '18_3n6'))
BC.data.PS.sub <- fastinR::select_vars(BC.data.PS, FAS)
par(mfrow=c(2,1))
dataplot(BC.data.PS)
...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP, FAS)
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS, FAS)
par(mfrow=c(2,1))
dataplot(BCvsBC.data.PS)
dataplot(BCvsBC.data.PS.sub)

BCvsBC.data.PS.mod <- run_MCMC(datas=BCvsBC.data.PS.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
BCvsBC.data.WP.sub <- fastinR::select_vars(BCvsBC.data.WP, FAS)
par(mfrow=c(2,1))
dataplot(BCvsBC.data.WP.sub)
dataplot(BCvsBC.data.WP)


BCvsBC.data.WP.mod <- run_MCMC(datas=BCvsBC.data.WP.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
KF.data.PS.mod <- run_MCMC(datas=KF.data.PS.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
KF.data.WP.mod <- run_MCMC(datas=KF.data.WP.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
AC.data.PS.mod <- run_MCMC(datas=AC.data.PS.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
AC.data.WP.mod <- run_MCMC(datas=AC.data.WP.sub,
                           nIter=2000,
                           nBurnin=500,
                           nChains=4,
                           nThin=1,
...
modlist <- list('Blue crab PS' = list(mod  = BC.data.PS.mod$mod,
                                      prey = BC.data.PS.mod$res$prey.names),
                'Blue crab WPH' = list(mod  = BC.data.WP.mod$mod,
...
out <- lapply(modlist, function(l) {
  props <- extract(l$mod,pars='prop')$prop
