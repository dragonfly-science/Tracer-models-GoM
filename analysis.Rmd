...
BC.data.PS.sub <- fastinR::select_vars(BC.data.PS, FAS_BC_PS[1:6])
par(mfrow=c(2,1))
dataplot(BC.data.PS)
...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP, FAS_BC_WP[1:6])
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS, FAS_BC_PS[1:6])
par(mfrow=c(2,1))
...
BCvsBC.data.WP.sub <- fastinR::select_vars(BCvsBC.data.WP, FAS_BC_WP[1:6])
par(mfrow=c(2,1))
