...
BC.data.PS.sub <- fastinR::select_vars(BC.data.PS, FAS_BC_PS[1:8])
par(mfrow=c(2,1))
dataplot(BC.data.PS)
...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP, FAS_BC_WP[1:7])
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS, FAS_BC_PS[1:8])
par(mfrow=c(2,1))
...
KF.data.PS.sub <- fastinR::select_vars(KF.data.PS, FAS[1:9])
par(mfrow=c(2,1))
dataplot(KF.data.PS)
...
KF.data.WP.sub <- fastinR::select_vars(KF.data.WP, FAS[1:8])
par(mfrow=c(2,1))
