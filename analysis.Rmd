...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP, FAS[1:7])
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS, FAS[1:7])
par(mfrow=c(2,1))
...
BCvsBC.data.WP.sub <- fastinR::select_vars(BCvsBC.data.WP, FAS[1:7])
par(mfrow=c(2,1))
...
KF.data.PS.sub <- fastinR::select_vars(KF.data.PS, FAS[1:7])
par(mfrow=c(2,1))
dataplot(KF.data.PS)
...
KF.data.WP.sub <- fastinR::select_vars(KF.data.WP, FAS[1:7])
par(mfrow=c(2,1))
...
AC.data.PS.sub <- fastinR::select_vars(AC.data.PS, FAS[1:7])
par(mfrow=c(2,1))
dataplot(AC.data.PS)
...
AC.data.WP.sub <- fastinR::select_vars(AC.data.WP, FAS[1:7])
par(mfrow=c(2,1))
