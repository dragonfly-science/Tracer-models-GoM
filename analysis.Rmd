...
PP %<>% ungroup() %>% mutate(prey.ix = paste(`EwE group`)) %>% group_by(PP,Predator,prey.ix,gr_site) %>% filter(PP=='Pred' | (PP=='Prey' & n()>=5))
...
```{r}
FAS <- which(colnames(KF.data.PS$preds.FA) %in% c('18_1n9c',
                                                  '18_3n3',
                                                  '22_6n3',
                                                  '16_1n7',
                                                  '16_0',
