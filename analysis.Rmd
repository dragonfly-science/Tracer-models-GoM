...
BC.data.WP.sub <- fastinR::select_vars(BC.data.WP)
par(mfrow=c(2,1))
...
BCvsBC.data.PS.sub <- fastinR::select_vars(BCvsBC.data.PS)
par(mfrow=c(2,1))
...
BCvsBC.data.WP.sub <- fastinR::select_vars(BCvsBC.data.WP)
par(mfrow=c(2,1))
...
KF.data.PS.sub <- fastinR::select_vars(KF.data.PS)
par(mfrow=c(2,1))
dataplot(KF.data.PS)
...
KF.data.WP.sub <- fastinR::select_vars(KF.data.WP)
par(mfrow=c(2,1))
...
AC.data.PS.sub <- fastinR::select_vars(AC.data.PS)
par(mfrow=c(2,1))
dataplot(AC.data.PS)
...
AC.data.WP.sub <- fastinR::select_vars(AC.data.WP)
par(mfrow=c(2,1))
